 ...
 *
 * Uses useShell() rather than useContext(ShellContext) directly so that
 * TypeScript resolves against the properly-typed hook return value
 * (ShellContextType) rather than the raw context generic.
 */
